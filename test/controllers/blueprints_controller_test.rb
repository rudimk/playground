...
class BlueprintsControllerTest < ActionController::TestCase
  ...
  test "should create blueprint" do
    assert_difference('Blueprint.count') do
      post :create, blueprint: { blueprint_id: @blueprint.blueprint_id, container_id: @blueprint.container_id, description: @blueprint.description, name: @blueprint.name }
    end
  ...
  test "should update blueprint" do
    patch :update, id: @blueprint, blueprint: { blueprint_id: @blueprint.blueprint_id, container_id: @blueprint.container_id, description: @blueprint.description, name: @blueprint.name }
    assert_redirected_to blueprint_path(assigns(:blueprint))
  end
