...
class ContainersControllerTest < ActionController::TestCase
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post :create, container: { container_id: @container.container_id, name: @container.name, port: @container.port, subdomain: @container.subdomain, user_id: @container.user_id }
    end
  ...
  test "should update container" do
    patch :update, id: @container, container: { container_id: @container.container_id, name: @container.name, port: @container.port, subdomain: @container.subdomain, user_id: @container.user_id }
    assert_redirected_to container_path(assigns(:container))
  end
